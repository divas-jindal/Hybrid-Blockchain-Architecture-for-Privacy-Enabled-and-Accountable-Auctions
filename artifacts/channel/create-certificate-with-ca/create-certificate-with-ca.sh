...
createCertificateForOrg3() {
  ...
  fabric-ca-client register --caname ca.org3.example.com --id.name org3admin --id.secret org2adminpw --id.type admin --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:9054 --caname ca.org3.example.com -M ${PWD}/crypto-config-ca/peerOrganizations/org3.example.com/peers/peer0.org3.example.com/msp --csr.hosts peer0.org3.example.com --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:9054 --caname ca.org3.example.com -M ${PWD}/crypto-config-ca/peerOrganizations/org3.example.com/peers/peer0.org3.example.com/tls --enrollment.profile tls --csr.hosts peer0.org2.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:9054 --caname ca.org3.example.com -M ${PWD}/crypto-config-ca/peerOrganizations/org3.example.com/peers/peer1.org3.example.com/msp --csr.hosts peer1.org3.example.com --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:9054 --caname ca.org3.example.com -M ${PWD}/crypto-config-ca/peerOrganizations/org3.example.com/peers/peer1.org3.example.com/tls --enrollment.profile tls --csr.hosts peer1.org3.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://user1:user1pw@localhost:9054 --caname ca.org3.example.com -M ${PWD}/crypto-config-ca/peerOrganizations/org3.example.com/users/User1@org3.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://org3admin:org3adminpw@localhost:9054 --caname ca.org3.example.com -M ${PWD}/crypto-config-ca/peerOrganizations/org3.example.com/users/Admin@org3.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
